...
\foreach \x in {Al, Cu, Fe, Ni}{
    \begin{frame}
        \includegraphics[width=\textwidth]{/Users/briansquires/Documents/LIBS/data/20220713/Argon+Green_IR_test/\x/plot.png}
    \end{frame}
}

\begin{frame}
    \includegraphics[width=\textwidth]{/Users/briansquires/Documents/LIBS/data/20220713/gradient.png}
\end{frame}
